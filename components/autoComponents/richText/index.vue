<template>
	<div class="richText">
		...
		<div class="rc-design-vue-preview rc-design-component-text-preview">
			<div :class="['cap-richtext',currentObj.fullScreen==='1'||currentObj.fullScreen==='true'?'cap-richtext--fullscreen':'']"
			 :style="{'background-color': currentObj.backGColor}" v-if="currentObj.contentRich" v-html="currentObj.contentRich"></div>
			<div v-if="!currentObj.contentRich" :class="['cap-richtext',currentObj.fullScreen==='1'||currentObj.fullScreen==='true'?'cap-richtext--fullscreen':'']"
			 color="#f9f9f9" content fullscreen="0" type="rich_text" __zent-design-uuid__="7b433852-3550-4a02-8758-d12af41e61ed"
